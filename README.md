...
### Consulta Documental
- **RAG Avanzado:** Recuperación semántica vía pgvector.
...
- **Indexación Inteligente:** Chunking con overlap y embeddings con `embeddinggemma`.
- **Persistencia Total:** Almacenamiento vectorial en PostgreSQL.
...
## 5. Funcionamiento Interno (IA & RAG)
...
6.  **Consulta:** El sistema recupera los fragmentos más relevantes y genera una respuesta contextualizada usando el LLM local.
...
- ⚠️ Multiusuario con roles y permisos detallados.
